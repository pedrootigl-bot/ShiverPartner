# Seção Programa — layout referência

## Objetivo

Seção `PartnerProgram` alinhada ao modelo split: copy + visual com cards glassmorphism flutuantes.

## Estrutura

### Esquerda
- Eyebrow, título com accent, texto, CTAs
- 3 features (parceria / comissões / suporte)
